...
def main():
    ...
    # Args
    input_pattern = '/home/ubuntu/results/finemapping_1kg/tmp/filtered_input/*.json.gz'
    out_json = 'configs_1kg/manifest.json.gz'
    valid_chrom = set([str(chrom) for chrom in range(1, 22)])  # range(1, 23)])
    method = 'distance'

    # Path patterns (server)
    out_path = '/home/ubuntu/results/finemapping_1kg/output/study_id={0}/phenotype_id={1}/bio_feature={2}/chrom={3}'
    log_path = '/home/ubuntu/results/finemapping_1kg/logs/study_id={0}/phenotype_id={1}/bio_feature={2}/chrom={3}'
    tmp_path = '/home/ubuntu/results/finemapping_1kg/tmp/study_id={0}/phenotype_id={1}/bio_feature={2}/chrom={3}'
    ld_ref = '/lustre/scratch117/cellgen/team297/mel41/sumstats_clump/cheers/1KG_HG38_EUR/EUR_r2_maf0p01/'
