...
# $6 FAILED JOB INDEX (will be a tissue and chr)
...
for CHR in "${chromosomes[@]}"
  do
  echo $CHR
  if [[ -f ${ANNOTDIR}/${PREFIX}_${t}.${CHR}.l2.ldscore.gz ]]; then
...
--ld-wind-cm 1 \
--annot ${ANNOTDIR}/${PREFIX}_${t}.${CHR}.annot.gz \
--thin-annot \
--out ${ANNOTDIR}/${PREFIX}_${t}.${CHR} \
